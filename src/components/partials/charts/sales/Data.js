...
export const coinOverview = {
  labels: ["Bitcoin", "Ethereum", "Cil", "Avax", "USDT"],
  stacked: true,
  datasets: [
    {
      label: "Buy Orders",
      color: ["#f98c45", "#6466f1", "#6466f1", "#e84142", "#79f1dc"],
      backgroundColor: ["#f98c45", "#6466f1", "#6466f1", "#e84142", "#79f1dc"],
    ...
    },
    {
      ...
      fillOpacity: "0.5",
      //color : [NioApp.hexRGB("#f98c45",.2),NioApp.hexRGB("#6466f1",.4),NioApp.hexRGB("#1fe0ac",.4),NioApp.hexRGB("#6b79c8",.4),NioApp.hexRGB("#79f1dc",.4)],
