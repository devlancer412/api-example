          ...
          <BlockHead size="sm">
                ...
                <li>
                  <div className="form-group">
                    <div className="custom-control custom-control-xs custom-checkbox">
                      ...
                      <Label className="custom-control-label" for="checkbox">
                        <span className="d-none d-sm-inline-block">Show</span> Cancelled
                      </Label>
                    </div>
                  </div>
                </li>
            ...
            <div className={`search-wrap search-wrap-extend ${!onSearch ? "active" : ""}`}>
              <div className="search-content">
                ...
                />
                <Link to="#" className="search-submit btn btn-icon">
                  <Icon name="search"></Icon>
                </Link>
              </div>
            </div>
